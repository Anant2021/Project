 ...
 * Chrysler.java
 *
 * Created on Jun 23, 2019, 11:17:42 AM
 */
 ...
 * @author user
 */
public class Chrysler extends javax.swing.JFrame {

    /** Creates new form Chrysler */
    public Chrysler() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jComboBox1.setBounds(240, 70, 130, 40);

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/newpackage/chrysler-logo.jpg"))); // NOI18N
        jLabel1.setText("jLabel1");
        jPanel2.add(jLabel1);
        jLabel1.setBounds(600, 0, 290, 190);
        ...
        jScrollPane1.setBounds(0, 190, 890, 60);
   ...
   Car_Page1 h1= new   Car_Page1();
    ...
    private void jComboBox1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jComboBox1ActionPerformed
        ...
        try {
            ...
            String query;
            query="  select * from Chrysler where Model_Name ='"+Model_Name+"' ; ";
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            Statement s=c.createStatement();
            String query;
            query="  select * from Chrysler where Model_Name ='%"+name+"%' ; ";
            ResultSet rs  =s.executeQuery(query);
            if(rs.next()) {
                do
                {
