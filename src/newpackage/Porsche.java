 ...
 * PORSCHE.java
 *
 * Created on Jun 22, 2019, 8:57:21 PM
 */
...
public class Porsche extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("   HERE ARE SOME CARS MANUFACTURED BY  PORSCHE");
        jPanel1.add(jLabel2);
        ...
        jPanel2.add(jLabel5);
        jLabel5.setBounds(10, 90, 200, 30);
        ...
        jComboBox1.setBounds(230, 90, 130, 30);
        ...
        jTextField1.setBounds(210, 40, 190, 30);

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/newpackage/Porsche.jpg"))); // NOI18N
        jLabel1.setText("jLabel1");
        jPanel2.add(jLabel1);
        jLabel1.setBounds(500, 0, 340, 190);
        ...
        jScrollPane1.setBounds(0, 210, 850, 60);

        jLabel3.setFont(new java.awt.Font("Tahoma", 0, 48));
        jLabel3.setText("select car");
        jLabel3.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(255, 51, 51), 6));
        ...
        jPanel2.add(jLabel3);
        jLabel3.setBounds(0, 270, 510, 330);
        ...
        jButton1.setBounds(400, 40, 60, 30);
    ...
    private void jComboBox1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jComboBox1ActionPerformed
         if(jComboBox1.getSelectedItem()=="Select here")
         {
          ...
          if(jComboBox1.getSelectedItem()=="Porsche Cayenne")
         {
             ImageIcon picture= new ImageIcon("src/newpackage/porsche-cayenne.JPG");
                   jLabel3.setIcon(picture);
          }
           if(jComboBox1.getSelectedItem()=="Porsche Panamera")
         {
             ImageIcon picture= new ImageIcon("src/newpackage/porsche panamera.JPG");
                   jLabel3.setIcon(picture);
          }

        if(jComboBox1.getSelectedItem()=="Porsche 718")
         {
             ImageIcon picture= new ImageIcon("src/newpackage/porsche 718.JPG");
                   jLabel3.setIcon(picture);
          }

  if(jComboBox1.getSelectedItem()=="Porsche 911")
         {
             ImageIcon picture= new ImageIcon("src/newpackage/porsche 911.JPG");
                   jLabel3.setIcon(picture);
          }
        ...
        try {
            ...
            String query;
           query="  select * from Porsche where Model_Name ='"+Model_Name+"' ; ";
  ...
  if(jComboBox1.getSelectedItem()=="Porsche 911")
        ...
        try {
            ...
            Statement s=c.createStatement();
            String query;
            query="  select * from Porsche where Model_Name ='"+name+"' ; ";
            ResultSet rs  =s.executeQuery(query);
            if(rs.next()) {
                do
                {
